                    ...
                    <form method="POST" action="{{ route('admin.store') }}" enctype="multipart/form-data">
                        ...
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                            <div class="form-group">
                                ...
                                <input type="text" name="txtname" class="form-input" placeholder="Nhập tên game" 
                            ...
                            <div class="form-group">
                                ...
                                <select name="txtcategory" class="form-select" required>
                                    ...
                                    @foreach ($categories as $cate)
                                        <option value="{{ $cate->theloai_ct }}" {{ old('txtcategory') == $cate->theloai_ct ? 'selected' : '' }}>
                                            {{ $cate->theloai_ct }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="txtmota" class="form-textarea" placeholder="Mô tả về game..." required>{{ old('txtmota') }}</textarea>
                            @error('txtmota')
                                <span class="error-text">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div style="display: grid; grid-template-columns: 1fr 1fr ; gap: 20px;">
                            <div class="form-group">
                                ...
                                <input type="text" name="txtgia" class="form-input" placeholder="0 hoặc Free" 
                                       value="{{ old('txtgia') }}" required>
                                @error('txtgia')
                                    <span class="error-text">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <input type="number" name="txtsoluong" class="form-input" placeholder="Nhập số lượng" 
                                       min="0" value="{{ old('txtsoluong') }}" required>
                                @error('txtsoluong')
                                    <span class="error-text">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="file-upload">
                                <input type="file" name="txtanh" accept="image/*" style="display: none;" required 
                        ...
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                            <div class="form-group">
                                ...
                                <textarea name="txtcauhinhtt" class="form-textarea" 
                                          placeholder="Mô tả cấu hình tối thiểu..." required>{{ old('txtcauhinhtt') }}</textarea>
                                @error('txtcauhinhtt')
                                    <span class="error-text">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <textarea name="txtcauhinhdx" class="form-textarea" 
                                          placeholder="Mô tả cấu hình đề xuất..." required>{{ old('txtcauhinhdx') }}</textarea>
                                @error('txtcauhinhdx')
                                    <span class="error-text">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div style="display: flex; gap: 12px; justify-content: flex-end;">
                            ...
                            <button type="submit" name="submit" class="btn btn-primary">Thêm game</button>
                        </div>
                    </form>
                </div>
            </div>
